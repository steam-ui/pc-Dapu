...
gulp.task("copy-html", async()=> {
    gulp.src('*.html')
    .pipe(gulp.dest('D:\\phpStudy\\WWW\\dapu'));
});
...
gulp.task('copy-img',async()=>{
    ...
    .pipe(gulp.dest('D:\\phpStudy\\WWW\\dapu\\img'));
});
...
gulp.task('copy-css',async()=>{
    gulp.src('css/*.css')
    .pipe(gulp.dest('D:\\phpStudy\\WWW\\dapu\\css'));
});
...
gulp.task('copy-js',async()=>{
    gulp.src('js/*.js')
    .pipe(gulp.dest('D:\\phpStudy\\WWW\\dapu\\js'));
});
...
gulp.task('copy-php',async()=>{
    gulp.src('php/*.php')
    .pipe(gulp.dest('D:\\phpStudy\\WWW\\dapu\\php'));
});
